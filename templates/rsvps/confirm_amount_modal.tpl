        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <button class="btn btn-primary btn-circle btn-lg" type="button" onclick="updateAmount(1)"><i class="fa  fa-plus"></i></button>
                    ...
                    <button class="btn btn-primary btn-circle btn-lg" type="button" onclick="updateAmount(-1)"><i class="fa fa-minus"></i></button>
                </div>
